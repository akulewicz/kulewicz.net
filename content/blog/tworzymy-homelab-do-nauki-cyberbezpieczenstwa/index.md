...
## Początkowa struktura homelab

Tak mogłaby wyglądać początkowa struktura Twojego pierwszego homelab:

- **Proxmox (host)** - IP: `192.168.1.5`, domena: `proxmox.homelab.lan`

- **Pi-hole (DNS)** - IP: `192.168.1.60`, vCPU: 1, RAM: 512 MB, Dysk: 4 GB , domena: `dns.homelab.lan`

- **Wazuh (monitoring)** - IP: `192.168.1.10`, vCPU: 2, RAM: 8 GB, Dysk: 60–80 GB, domena: `wazuh.homelab.lan`

- **Reverse Proxy (Nginx Proxy Manager)** - IP: `192.168.1.40`, vCPU: 1, RAM: 512 MB–1 GB, Dysk: 10 GB, domena: `proxy.homelab.lan`

- **Nextcloud** - IP: `192.168.1.30`, vCPU: 1, RAM: 2 GB, Dysk: 50–100 GB, domena: `cloud.homelab.lan`

- **Web / API (FastAPI / WordPress)** - IP: `192.168.1.20`, vCPU: 1, RAM: 2 GB, Dysk: 20–30 GB, domena: `web.homelab.lan`, `blog.homelab.lan`

- **Kali Linux** - IP: `192.168.1.50`, vCPU: 1, RAM: 2–4 GB, Dysk: 20–30 GB, domena: `kali.homelab.lan`
